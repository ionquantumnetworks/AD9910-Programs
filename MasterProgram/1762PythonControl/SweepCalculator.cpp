...
start_stop calcStartStop(double centerFreq, double span, double maxFreq, double minFreq)
{
	...
	{
		Serial.print(F("Upper frequency out of bounds. Setting to specified max frequency of "));
	...
	{
		Serial.print(F("Lower frequency out of bounds. Setting to specified min frequency of "));
